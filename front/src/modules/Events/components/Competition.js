            ...
            <div className="container-fluid ">
                <h2 className="titleE"> Competition</h2>
                        ...
                        <div className="container_card1 row" >
                            ...
                            <img src="https://via.placeholder.com/150/08C94E?text=user-img" className="rounded-circle"/>
                            </div>
                   
                            <div className="details_card">
                                <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                                <div className="location_event" > <h6> <HiLocationMarker/> GREEK CAMPUS</h6></div>
                                <div className="date_time_event"> <h6> <MdDateRange/>4/1</h6></div>
                        ...
                        <div className="container_card2 row ">
                            <div className="img_card">
                            <img src="https://via.placeholder.com/150/FF7F50?text=user-img" className="rounded-circle"/>
                        </div>
                            <div className="details_card">
                                <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                                <div className="location_event" > <h6> <HiLocationMarker/> GREEK CAMPUS</h6></div>
                        ...
                        <div className="container_card3 row ">
                            <div className="img_card">
                            <img src="https://via.placeholder.com/150/FFD700?text=user-img" className="rounded-circle"/>
                        </div>
                            <div className="details_card">
                                <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                                <div className="location_event" > <h6> <HiLocationMarker/> GREEK CAMPUS</h6></div>
                                <div className="date_time_event"> <h6> <MdDateRange/>5/5</h6></div>
