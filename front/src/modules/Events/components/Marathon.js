...
function Marathon() {
    return (
        <div className="container-fluid ">
            <h2 className="titleE">Marathons</h2>

            <div className="container_card row" >
                <div className="img_card " >
                    <img alt="event" src="https://via.placeholder.com/150/2F4F4F?text=user-img" className="rounded-circle" />
                </div>
            ...
            <div className="container_card row ">
                <div className="img_card">
                    <img alt="event" src="https://via.placeholder.com/150/000080?text=user-img" className="rounded-circle" />
                </div>
                <div className="details_card">
                    <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                    <div className="location_event" > <h6> <HiLocationMarker /> GREEK CAMPUS</h6></div>
            ...
            <div className="container_card row ">
                <div className="img_card">
                    <img alt="event" src="https://via.placeholder.com/150/8B008B?text=user-img" className="rounded-circle" />
                </div>
                <div className="details_card">
                    <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                    <div className="location_event" > <h6> <HiLocationMarker /> GREEK CAMPUS</h6></div>
