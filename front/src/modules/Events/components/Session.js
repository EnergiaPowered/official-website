...
function Session() {
    return (
        <div className="container-fluid ">
            <h2 className="titleE">Sessions</h2>

            <div className="container_card row" >
                <div className="img_card " >
                    <img alt="event" src="https://via.placeholder.com/150/DE38F1?text=user-img" className="rounded-circle" />
                </div>
            ...
            <div className="container_card row ">
                <div className="img_card">
                    <img alt="event" src="https://via.placeholder.com/150/D4C508?text=user-img" className="rounded-circle" />
                </div>
                <div className="details_card">
                    <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                    <div className="location_event" > <h6> <HiLocationMarker /> GREEK CAMPUS</h6></div>
            ...
            <div className="container_card row ">
                <div className="img_card">
                    <img alt="event" src="https://via.placeholder.com/150/0859C9?text=user-img" className="rounded-circle" />
                </div>
                <div className="details_card">
                    <div className="title_event"    > <h4>BE CREATIVE</h4></div>
                    <div className="location_event" > <h6> <HiLocationMarker /> GREEK CAMPUS</h6></div>
