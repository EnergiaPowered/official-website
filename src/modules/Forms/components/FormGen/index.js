...
const FormGen = () => {
        ...
        for(let i = 1; i<= fieldProps.fieldLabels.length ; i++){
            ...
            if(field.type === "Selection"){
                ...
                for(let item of options){
                    modified.push({value:Object.values(item)[0],label:Object.values(item)[0]})
                }
                field["options"] =modified;
            }
            else{
                field["placeholder"] = getValue(fieldProps.fieldPlaceholders,`field_${i}_`)
            }
                fields.push(field);
        }
        return fields;
    ...
    const submit =(values)=>{
        ...
        const formData =
            {
                title:values.name,               //"" Title of the event => also used to generate form's url
            ...
            axios.post(FORM_END_POINT, formData)
    ...
    return ( 
        ...
        <h1 style={{textAlign:"center", padding :"4em", marginLeft:"-3em"}}>Form Creation</h1>
        <br/><br/>
        ...
        <div className="col-lg-10 col-sm-12">
            <Form onFinish={submit} autoComplete="off">
                ...
                <Button type="ghost" style={{color:"white"}} shape="round" onClick={() => addField()} block >
                   + Add field
                </Button>
                        <br/>
                        <br/>
